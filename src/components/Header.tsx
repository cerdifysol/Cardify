    ...
    <header className="sticky top-0 z-10 bg-[#242424] border-b border-[#333333]">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex space-x-8">
          <Link to="/issue" className="hover:text-[#512da8] transition-colors">
            Issue Certificate
          </Link>
          <Link to="/verify" className="hover:text-[#512da8] transition-colors">
            Verify Certificate
          </Link>
          {connected && isUserCreated && (
            <Link to="/profile" className="hover:text-[#512da8] transition-colors">
              Profile page
            </Link>
          )}
        </nav>
