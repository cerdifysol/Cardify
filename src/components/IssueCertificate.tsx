...
export default function IssueCertificate() {
  ...
  const handleMint = async () => {
    ...
    try {
      ...
      const metadataJSON = {
        ...
        image: imageURI,
        attributes: [
          { trait_type: "issuer", value: "MyCertApp" }, // 💡 Має збігатись із ISSUER_TAG в nft.ts
          { trait_type: "created_by", value: publicKey.toBase58() },
        ],
      };
  ...
  return (
    <div className="bg-[#1a1f2e]/30 p-6 rounded-lg border border-[#512da8]/50 transition-colors max-w-[500px] m-auto">
      ...
      />
      <button onClick={handleMint} disabled={loading} className="btn btn-accent w-full bg-[#512da8] p-3 cursor-pointer  ">
